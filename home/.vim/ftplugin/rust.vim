...
" Check for Rustfmt
if vimrc#rust#detect#DetectRustupComponent(vimrc#rust#detect#RustfmtComponent())
...
" Check for Clippy
if vimrc#rust#detect#DetectRustupComponent(vimrc#rust#detect#ClippyComponent())
